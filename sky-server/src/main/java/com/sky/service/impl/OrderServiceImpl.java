...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderPaymentVO payment(OrdersPaymentDTO ordersPaymentDTO) throws Exception {
       ...
       /* //调用微信支付接口，生成预支付交易单
        ...
        jsonObject.put("orderNum", ordersPaymentDTO.getOrderNumber());
        jsonObject.put("total", new BigDecimal(0.01)); // 假设支付金额是 BigDecimal 类型
        jsonObject.put("description", "苍穹外卖订单");
        jsonObject.put("openid", user.getOpenid());

        String str=ordersPaymentDTO.getOrderNumber();
        orderMapper.pay(userId,str);
